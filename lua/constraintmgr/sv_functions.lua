...
CMgr.SendTableSingle = function(ply,tbl) -- send details of a single constraint
    ...
    if tbl.Ent1 and tbl.Ent1:GetBoneCount() <= 1 then tbl.Bone1 = nil end
    if tbl.Ent2 and tbl.Ent2:GetBoneCount() <= 1 then tbl.Bone2 = nil end
    if tbl.Ent4 and tbl.Ent4:GetBoneCount() <= 1 then tbl.Bone4 = nil end
